...
if __name__ == "__main__":
    ...
    clickWindowed = clicks.window(5,5)
    clickWindowed = clickWindowed.reduceByKey(lambda a, b: a + b)
    clickWindowed.pprint()

    running_counts = clickWindowed.updateStateByKey(updateFunc, initialRDD=initialStateRDD)
